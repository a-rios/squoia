...
export MOSES_SCRIPTDIR="/mnt/storage/clfiles/resources/applications/mt/moses/vGitHub/scripts"
...
#cat $RAW_FILE | $MOSES_SCRIPTDIR/ems/support/split-sentences.perl -l es |  perl -p -e 's/<P>\n//' |perl -p -e 's/($)/ #EOS\1/;'

# perl $TOKENIZER | lookup -f lookup.script -flags cKv29TT > $TMP_DIR/test.xfst
# 
