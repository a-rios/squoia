...
perl -I$SQUOIAMATXIN -I$ESDEMATXIN $SQUOIAMATXIN/outputOrderChunk.pl < $TESTOUTPUT.xml 2>> ./junk > $TESTOUTPUT.stts

flookup /home/clppmolif/molifde-anne/fst/SttsGeneratorTool.fst < $TESTOUTPUT.stts > $TESTOUTPUT.fstout
