...
{
		my @linkerSP  = $sentence->findnodes('descendant::CHUNK[(@type="grup-sp" or @type="coor-sp") and NODE[@lem="para"] and CHUNK[(@type="coor-v" or @type="grup-verb") and descendant::NODE[@lem="que" and @mi="CS"]]  ] ');
		...
		my @linkerADV  = $sentence->findnodes('descendant::CHUNK[(@type="sadv" or @type="coor-sadv") and NODE[@lem="mientras"] and CHUNK[(@type="coor-v" or @type="grup-verb") and descendant::NODE[@lem="que" and @mi="CS"]]  ] ');		
