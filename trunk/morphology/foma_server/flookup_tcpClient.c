//  gcc -o flookup_tcpClient flookup_tcpClient.c /usr/local/lib/libfoma.a -lz
...
char *usagestring = "Usage: flookup_tcpClient [-P port number]\n";
char *helpstring = "flookup_tcpClient reads (tokenized) data from stdin and calls flookup_tcpServer for spell checking\n"
"Options:\n"
"-h\t\tprint help\n"
