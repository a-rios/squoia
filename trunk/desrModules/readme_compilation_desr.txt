...
g++ -c -o desr_client.o desr_client.cc -I/opt/matxin/local/include/

# link parser client:
#/bin/bash /opt/matxin/freeling-3.0-trunk/libtool --tag=CXX --mode=link g++ -O3 -Wall -o desr_client desr_client.o
...
g++ -c -o desr_server.o desr_server.cc -std=gnu++0x -I/opt/matxin/local/include/ -I$DESRHOME/src/ -I/usr/include/python2.7/ -I$DESRHOME -I$DESRHOME/ixe/ -I$DESRHOME/classifier/
...
#/bin/bash /opt/matxin/freeling-3.0-trunk/libtool --tag=CXX --mode=link g++ -O3 -Wall -o desr_server desr_server.o $DESRHOME/src/libdesr.so $DESRHOME/ixe/libixe.a 
