...
# 		print STDERR "\n\n";
 		...
 		if( $verbChunk->exists('CHUNK[(@type="sn" or @type="date") and (@si="suj" or @si="suj-a")]' ) && !$verbChunk->exists('CHUNK[@type="sn" and (@si="suj" or @si="suj-a")]/NODE[@rel="suj" and (@pos="pd" or @pos="pi")]' ) && !&isLocalPerson($verbChunk) && !&isRelClause($verbChunk) && !$verbChunk->exists('self::CHUNK[@si="sentence" or @si="cd"]/NODE/NODE[@pos="cs"]') )
 		{
 		...
 		elsif($activeSubj && !$verbChunk->exists('child::*[@si="suj" or @rel="suj"]' ) && !&isLocalPerson($verbChunk) && !&isRelClause($verbChunk) && !$verbChunk->exists('CHUNK[@type="sn" and @si="impers"]') && !$verbChunk->exists('child::NODE[@form="hay" or @form="Hay"]') )
 		{	
