...
my ($verbsection) = $dom->findnodes('descendant::section[@id="nouns"]');
...
print "total number in section: ".scalar(keys %entries)."\n";
print "number of entries with at least one translation: $nbrOfTranslated\n";
print "number of entries with no translation: $nbrOfUntranslated\n";
